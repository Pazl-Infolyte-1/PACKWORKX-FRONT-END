...
const routes = [
  ...
  { path: '/salesorder', name: 'Sales Order', element: Index, key: '' },
  { path: '/skus', name: 'SKU', element: SKU, key: '' },
  { path: '/jobs', name: 'Jobs', element: Jobs, key: '' },
  { path: '/clients', name: 'Clients', element: Clients, key: '' },
  { path: '/workorders', name: 'Work Orders', element: WorkOrders, key: '' },
