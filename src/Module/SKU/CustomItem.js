...
function CustomItem({editTag,dropdownRef, addNewSkuData, isOpen, handleChange, clientDiasble, client, setIsOpen, handleSelect, skuType, setAddNewSkuData, updateSkuValues}) {
...
<label className="text-[16px] font-medium">Tags</label>
	<div
  className="rounded p-2 min-h-[42px] shadow-md border-l-2 rounded-md p-2 mt-2"
