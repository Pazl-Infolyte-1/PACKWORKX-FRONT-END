...
{/*<TrashIcon className="text-[#ff2d55] w-10 h-10 cursor-pointer" />*/}
...
const SkuDetails =() =>{
  ...
  <div className="mt-4 p-4 bg-white rounded-lg border border-[#c2c2c2] shadow-md w-full h-[600px]">
    ...
    <div className="flex justify-between items-center">
      ...
      <button className="cursor-pointer w-[132px] h-[40px] px-2 border border-[#8167E5] rounded-lg bg-transparent text-[#8167E5] text-[14px] font-['Lato'] leading-[20px] outline-none"
...
<div className="mt-10">
      <table className="w-[500px] ml-[50%] mb-[1%]">
        ...
        <tbody>
          <tr>
            <td className="px-4 py-2 text-[#7f7f7f] text-[15px] font-lato leading-[22px]">Total Qty:2000</td>
            <td className="px-4 py-2 text-[#7f7f7f] text-[15px] font-lato leading-[22px]">Total:</td>
            <td className="px-4 py-2 text-[#7f7f7f] text-[15px] font-lato leading-[22px]">74000</td>
          </tr>
          <tr>
            <td className="px-4 py-2"></td>
            <td className="px-4 py-2 text-[#7f7f7f] text-[15px] font-lato leading-[22px]">SGST:</td>
            <td className="px-4 py-2 text-[#7f7f7f] text-[15px] font-lato leading-[22px]">44400</td>
          </tr>
          <tr>
            <td className="px-4 py-2"></td>
            <td className="px-4 py-2 text-[#7f7f7f] text-[15px] font-lato leading-[22px]">CGST:</td>
            <td className="px-4 py-2 text-[#7f7f7f] text-[15px] font-lato leading-[22px]">44400</td>
          </tr>
          <tr>
            <td className="px-4 py-2"></td>
            <td className="px-4 py-2 text-[#7f7f7f] text-[15px] font-lato leading-[22px]">Total Incl of GST:</td>
            <td className="px-4 py-2 text-[#7f7f7f] text-[15px] font-lato leading-[22px]">828800</td>
          </tr>
        </tbody>
      </table>
    </div>
