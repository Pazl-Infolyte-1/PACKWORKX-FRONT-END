    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-8 mb-6">
        <div>
          ...
          <div className="text-gray-500 text-sm mt-1">Enter lower value than 1.95 GB</div>
        </div>
      ...
      <ActionButton label={'Save'} customColor="bg-red-500 text-white" onClick={handleSave} />
    </div>
  )
}
