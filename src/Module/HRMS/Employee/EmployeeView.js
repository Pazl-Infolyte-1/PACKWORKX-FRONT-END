...
function EmployeeView() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await employeeApi.getEmployeeDataById(id)
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                ...
                <div className="mt-2 sm:mt-0 flex gap-1  ">
                  ...
                  <Close className="cursor-pointer" onClick={() => navigate('/employeelist')} />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-gray-800 mt-1 capitalize">
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  {employeeData.contract_end_date && (
                    <div className="flex flex-col">
                      ...
                      <span className="text-gray-800 mt-1">
                        {formatDate(employeeData.contract_end_date)}
                      </span>
                    </div>
                  )}
                  <div className="flex flex-col">
