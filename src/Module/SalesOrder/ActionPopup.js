...
function ActionPopup({ visible, setVisible }) {
  ...
  return (
    <PopUp visible={visible} setVisible={setVisible} width="500px" height="500px" size="m">      
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          >
            <option value="" disabled>Last Invoices</option> 
        ...
        <div className=" border-2 border-[#ae9eed] rounded-md  overflow-hidden">
