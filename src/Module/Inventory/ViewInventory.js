            ...
            {itemDetails?.products ? (
              <div className="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div className="p-4 space-y-4">
                  ...
                  {/* Custom Fields */}
                  {itemDetails.products.custom_fields && (
                    <div className="bg-gray-50 p-3 rounded-md">
                      <h4 className="text-sm font-medium text-gray-700 mb-2">Additional Details</h4>
                      <div className="space-y-1">
                        {Object.entries(parseCustomFields(itemDetails.products.custom_fields)).map(
                          ([key, value]) => (
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3 text-sm">
                              ...
                              <span className="text-gray-600">Type: <span  className={`px-3 py-1 rounded-full text-xs font-medium border ${getTypeColor(adj.type)}`}> {adj.type}</span></span>
                            </div>
                          </div>
                        </div>
